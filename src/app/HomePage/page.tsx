...
function HomePage() {
  return (
    ...
    <><section className='bg-black px-3 md:px-[135px] flex flex-col justify-evenly md:flex-row  md:items-center py-[50px]'>
      ...
      <div className='mt-[50px] md:mt-100 '>
    ...
    </section><section className="bg-black px-3 md:px-[135px] flex flex-col justify-evenly md:flex-row  md:items-center py-[50px]">
        ...
        <div className="mt-[50px] md:mt-0 ">
          <Image src={foodpic1} alt="Hero Image" className="" width={560} height={130} />
          <div className="flex flex-col md:flex-row mt-[16px] md:mt-[0]">
            <Image src={foodpic2} width={300} height={194} alt="Hero Image" className="" />
            <Image src={foodpic3} width={322} height={194} alt="Hero Image" className="" />
          </div>
        </div>
